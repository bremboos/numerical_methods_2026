...
# --- 4-5. Обчислення кумулятивної відстані (Haversine) ---
...
# --- 10-12. Побудова графіків ---

# Графік 1: Профіль висоти маршруту
...
# Блок з характеристиками у лівому верхньому куті
...
# Графік 2: Вплив кількості вузлів на точність сплайна
...
splines_data = {}  # Словник для збереження даних для 3-го графіка
...
# Графік 3: Абсолютна похибка інтерполяції
...
# --- Виведення характеристик у консоль ---
